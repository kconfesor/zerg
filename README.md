...
A fresh install seeds two roles — `coder` and `qa` — ready to run. They are ordinary rows: rename
...
Pinned versions and their gotchas: [ARCHITECTURE.md §11](ARCHITECTURE.md#11-stack).
